...
def predict():
    ...
    elif model.predict(input)[0][22] == 1.0:
        prediction = "pomegranate"
    elif model.predict(input)[0][23] == 1.0:
        prediction = "rice"
    elif model.predict(input)[0][24] == 1.0:
        prediction = "Soyabean"
    elif model.predict(input)[0][25] == 1.0:
        prediction = "Sugarcane"
    elif model.predict(input)[0][26] == 1.0:
        prediction = "watermelon"
    elif model.predict(input)[0][27] == 1.0:
        prediction = "Wheat"
    else:
